...
class GetDbTableInfo extends \Magento\Backend\App\Action {
    ...
    public function execute() {
        ...
        if ($table) {
            ...
            foreach ($rows as $value) $this->helper()->_echo($value['Field'].'|'.$value['Type'].'|'.$value['Null'].'|'.$value['Key'].'|'.$value['Default'].'|'.$value['Extra'].'|');
        }
    }
