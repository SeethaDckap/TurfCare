...
namespace Itoris\SmartFormerGold\plugins\charset_converter;
...
Class utf8class{
  ...
  function loadCharset($charset){
    ...
    if (!$lines) {
        \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo($this->onError(ERR_OPEN_MAP_FILE,"Error openning file: " . $charset));
        \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->safeExit();
    }
        //or die($this->onError(ERR_OPEN_MAP_FILE,"Error openning file: " . $charset));
  ...
  function onError($err_code,$err_text){
    \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo($err_code . " : " . $err_text . "<hr>\n");
  }
