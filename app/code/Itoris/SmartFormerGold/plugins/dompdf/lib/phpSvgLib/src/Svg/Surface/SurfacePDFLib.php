...
use Itoris\SmartFormerGold\plugins\dompdf\lib\phpSvgLib\src\Svg\Document;
    ...
    public function __construct(Document $doc, $canvas = null)
    {
        ...
        if (!$canvas) {
            ...
            if ($canvas->begin_document("", "") == 0) {
                \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo("Error: " . $canvas->get_errmsg());
