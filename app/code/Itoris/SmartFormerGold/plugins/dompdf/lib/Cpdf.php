 ...
 * @package Cpdf
 */
namespace Itoris\SmartFormerGold\plugins\dompdf\lib; 
...
EOT;
        ...
        if (!isset($this->fonts[$fontName])) {
            ...
            if (isset($this->fonts[$fontName])) {
                ...
                if ($fbtype) {
                    ...
                    $list = array(
                        'Ascent'       => 'Ascender',
                        'CapHeight'    => 'Ascender', //FIXME: phpFontLib is not grabbing this value, so we'll fake it and use the Ascender value // 'CapHeight'
    ...
    function stream($options = '')
    {
        ...
        if (headers_sent()) {
            \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo("Unable to stream pdf: headers already sent");
            \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->safeExit();
        }
        ...
        //echo $tmp;
        \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo($tmp);
        flush();
    }
    ...
    function addImagePng($file, $x, $y, $w = 0.0, $h = 0.0, &$img, $is_mask = false, $mask = null)
    {
        ...
        if (isset($this->imagelist[$file])) {
            ...
            if (defined("DEBUGPNG") && DEBUGPNG) {
                \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo('[addImagePng ' . $file . ']');
            }
            ...
            if ($data == '') {
                ...
                //debugpng
                if (defined("DEBUGPNG") && DEBUGPNG) {
                    \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo('trouble writing file from GD');
                }
            }
        ...
        if (isset($this->imagelist[$file])) {
            ...
            if (!$error) {
                ...
                if (mb_substr($data, 0, 8, '8bit') != $header) {
                    ...
                    if (defined("DEBUGPNG") && DEBUGPNG) {
                        \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo('[addPngFromFile this file does not have a valid header ' . $file . ']');
                    }
            ...
            if (!$error) {
                    ...
                    switch ($chunkType) {
                        case 'IHDR':
                            ...
                            if ($info['compressionMethod'] != 0) {
                                ...
                                //debugpng
                                if (defined("DEBUGPNG") && DEBUGPNG) {
                                    \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo('[addPngFromFile unsupported compression method ' . $file . ']');
                                }
                            ...
                            if ($info['filterMethod'] != 0) {
                                ...
                                //debugpng
                                if (defined("DEBUGPNG") && DEBUGPNG) {
                                    \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo('[addPngFromFile unsupported filter method ' . $file . ']');
                                }
                        ...
                        case 'tRNS':
                            ...
                            switch ($info['colorType']) {
                                ...
                                default:
                                    if (defined("DEBUGPNG") && DEBUGPNG) {
                                        \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo('[addPngFromFile unsupported transparency type ' . $file . ']');
                                    }
                                    break;
                            }
                ...
                if (!$haveHeader) {
                    ...
                    //debugpng
                    if (defined("DEBUGPNG") && DEBUGPNG) {
                        \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo('[addPngFromFile information header is missing ' . $file . ']');
                    }
                ...
                if (isset($info['interlaceMethod']) && $info['interlaceMethod']) {
                    ...
                    //debugpng
                    if (defined("DEBUGPNG") && DEBUGPNG) {
                        \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo('[addPngFromFile no support for interlaced images in pdf ' . $file . ']');
                    }
            ...
            if (!$error && $info['bitDepth'] > 8) {
                ...
                //debugpng
                if (defined("DEBUGPNG") && DEBUGPNG) {
                    \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo('[addPngFromFile bit depth of 8 or less is supported ' . $file . ']');
                }
            ...
            if (!$error) {
                switch ($info['colorType']) {
                    ...
                    default:
                        ...
                        //debugpng
                        if (defined("DEBUGPNG") && DEBUGPNG) {
                            \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo('[addPngFromFile alpha channel not supported: ' . $info['colorType'] . ' ' . $file . ']');
                        }
