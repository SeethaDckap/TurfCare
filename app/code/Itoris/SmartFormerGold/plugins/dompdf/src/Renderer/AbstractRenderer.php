 ...
 */
namespace Itoris\SmartFormerGold\plugins\dompdf\src\Renderer;

use Itoris\SmartFormerGold\plugins\dompdf\src\Adapter\CPDF;
use Itoris\SmartFormerGold\plugins\dompdf\src\Css\Color;
use Itoris\SmartFormerGold\plugins\dompdf\src\Css\Style;
...
abstract class AbstractRenderer
{
     ...
     * Rendering backend
     *
     * @var \Itoris\SmartFormerGold\plugins\dompdf\src\Canvas
     */
    protected $_canvas;
    ...
    protected function _background_image($url, $x, $y, $width, $height, $style)
    {
        ...
        if ($this->_dompdf->getOptions()->getDebugPng()) {
            \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo('[_background_image ' . $url . ']');
        }
        ...
        if ($this->_canvas instanceof CPDF &&
            ...
            if ($repeat === "no-repeat") {
                ...
                \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo('Unknown repeat!');
            }
        ...
        if (!$is_png && $this->_canvas instanceof CPDF) {
            ...
            //debugpng
            if ($this->_dompdf->getOptions()->getDebugPng()) \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo('[_background_image ' . $tmp_file . ']');
            ...
            //debugpng
            if ($this->_dompdf->getOptions()->getDebugPng()) {
                \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo('[_background_image unlink ' . $tmp_file . ']');
            }
