...
class Options
{
     ...
     * DO NOT set it to '/' since this could allow an attacker to use Itoris\SmartFormerGold\plugins\dompdf\src to
     ...
     * @see Itoris\SmartFormerGold\plugins\dompdf\src\Adapter\CPDF::PAPER_SIZES for valid sizes
     *
     * @var string
     */
     ...
     * CPDF. 'GD' renders PDFs to graphic files. {@link Itoris\SmartFormerGold\plugins\dompdf\src\CanvasFactory}
