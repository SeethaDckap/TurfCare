 ...
 */
namespace Itoris\SmartFormerGold\plugins\dompdf\src\FrameReflower;

use Itoris\SmartFormerGold\plugins\dompdf\src\Helpers;
use Itoris\SmartFormerGold\plugins\dompdf\src\FrameDecorator\Block as BlockFrameDecorator;
use Itoris\SmartFormerGold\plugins\dompdf\src\FrameDecorator\Image as ImageFrameDecorator;
...
class Image extends AbstractFrameReflower
{
    ...
    function get_min_max_width()
    {
        if ($this->get_dompdf()->getOptions()->getDebugPng()) {
            ...
            \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo("get_min_max_width() " .
        ...
        if ($this->get_dompdf()->getOptions()->getDebugPng()) \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo($width . ' ' . $height . ';');
