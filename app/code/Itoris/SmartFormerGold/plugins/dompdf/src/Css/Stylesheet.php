...
class Stylesheet
{
     ...
     *
     * @throws \Itoris\SmartFormerGold\plugins\dompdf\src\Exception
     */
    ...
    private function _specificity($selector, $origin = self::ORIG_AUTHOR)
    {
        ...
        if ($this->_dompdf->getOptions()->getDebugCss()) {
            ...
            /*DEBUGCSS*/
            \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo(sprintf("_specificity(): 0x%08x \"%s\"\n", self::$_stylesheet_origins[$origin] + (($a << 24) | ($b << 16) | ($c << 8) | ($d)), $selector));
            /*DEBUGCSS*/
            \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo("</pre>");
        }
...
//    }
     ...
     * of this class.
     *
     * @param \Itoris\SmartFormerGold\plugins\dompdf\src\Frame\FrameTree $tree
     */
    function apply_styles(FrameTree $tree)
    {
        ...
        foreach ($tree->get_frames() as $frame) {
            ...
            if ($p) {
                ...
                if ($DEBUGCSS) {
                    \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo("inherit:\n");
                    \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo("[\n");
            ...
            if ($DEBUGCSS) {
                \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo("DomElementStyle:\n");
                \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo("[\n");
                $style->debug_print();
                \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo("]\n");
                \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo("/$debug_nodename]\n</pre>");
            }
    ...
    protected function _image($val)
    {
        ...
        if ($DEBUGCSS) {
            ...
            \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo($this->get_protocol() . "\n" . $this->get_base_path() . "\n" . $path . "\n");
    ...
    private function _parse_properties($str)
    {
        ...
        if ($DEBUGCSS) \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo('[_parse_properties');
        ...
        foreach ($properties as $prop) {
          ...
          $important = preg_match("/(.*?)!\s*important/",$prop,$match);
            ...
            $prop = trim($prop);
            */
            if ($DEBUGCSS) \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo('(');
            ...
            if ($prop === "") {
                if ($DEBUGCSS) \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo('empty)');
                continue;
            }

            $i = mb_strpos($prop, ":");
            if ($i === false) {
                if ($DEBUGCSS) \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo('novalue' . $prop . ')');
                continue;
            }

            $prop_name = rtrim(mb_strtolower(mb_substr($prop, 0, $i)));
            $value = ltrim(mb_substr($prop, $i + 1));
            if ($DEBUGCSS) \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo($prop_name . ':=' . $value . ($important ? '!IMPORTANT' : '') . ')');
    ...
    private function _parse_sections($str, $media_queries = array())
    {
        ...
        if ($DEBUGCSS) \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo('[_parse_sections');
        foreach ($sections as $sect) {
            ...
            if ($DEBUGCSS) \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo('[section');
            ...
            foreach ($selectors as $selector) {
                ...
                if ($DEBUGCSS) \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo('#' . $selector . '#');
