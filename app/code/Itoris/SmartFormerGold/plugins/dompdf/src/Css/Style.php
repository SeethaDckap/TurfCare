 ...
 */
namespace Itoris\SmartFormerGold\plugins\dompdf\src\Css;

use Itoris\SmartFormerGold\plugins\dompdf\src\Adapter\CPDF;
use Itoris\SmartFormerGold\plugins\dompdf\src\Exception;
use Itoris\SmartFormerGold\plugins\dompdf\src\Helpers;
use Itoris\SmartFormerGold\plugins\dompdf\src\FontMetrics;
...
class Style
{
    ...
    function get_font_family()
    {
        ...
        if ($DEBUGCSS) {
            \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo("<pre>[get_font_family:");
            \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo('(' . $this->_props["font_family"] . '.' . $font_style . '.' . $this->__get("font_weight") . '.' . $weight . '.' . $subtype . ')');
        }
        ...
        foreach ($families as $family) {
            ...
            $family = trim($family, " \t\n\r\x0B\"'");
            if ($DEBUGCSS) {
                \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo('(' . $family . ')');
            }
            $font = $this->getFontMetrics()->getFont($family, $subtype);

            if ($font) {
                if ($DEBUGCSS) \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo('(' . $font . ")get_font_family]\n</pre>");
        ...
        $family = null;
        if ($DEBUGCSS) {
            \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo('(default)');
        }
        $font = $this->getFontMetrics()->getFont($family, $subtype);
    ...
    */
    ...
    protected function _image($val)
    {
        ...
        if ($DEBUGCSS) {
            \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo("<pre>[_image\n");
            \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo($parsed_url);
            \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo($this->_stylesheet->get_protocol() . "\n" . $this->_stylesheet->get_base_path() . "\n" . $path . "\n");
            \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo("_image]</pre>");
        }
        return $path;
    }
    ...
    {
        /*DEBUGCSS*/
        \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo("parent_font_size:" . $this->_parent_font_size . ";\n");
        /*DEBUGCSS*/
        foreach ($this->_props as $prop => $val) {
            /*DEBUGCSS*/
            \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo($prop . ':' . $val);
            /*DEBUGCSS*/
            if (isset($this->_important_props[$prop])) {
                /*DEBUGCSS*/
                \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo('!important');
                /*DEBUGCSS*/
            }
            /*DEBUGCSS*/
            \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo(";\n");
            /*DEBUGCSS*/
        }
        /*DEBUGCSS*/
    }
