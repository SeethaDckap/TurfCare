...
use Itoris\SmartFormerGold\plugins\dompdf\src\FrameDecorator\AbstractFrameDecorator;
use DOMXPath;
use Itoris\SmartFormerGold\plugins\dompdf\src\FrameDecorator\Page as PageFrameDecorator;
use Itoris\SmartFormerGold\plugins\dompdf\src\FrameReflower\Page as PageFrameReflower;
...
class Factory
{
    ...
    static function decorate_frame(Frame $frame, Dompdf $dompdf, Frame $root = null)
    {
        ...
        $decorator  = "Itoris\\SmartFormerGold\\plugins\\dompdf\\src\\FrameDecorator\\$decorator";
        $reflower   = "Itoris\\SmartFormerGold\\plugins\\dompdf\\src\\FrameReflower\\$reflower";
    ...
    protected static function getPositionerInstance($type)
    {
        if (!isset(self::$_positioners[$type])) {
            $class = '\\Itoris\\SmartFormerGold\\plugins\\dompdf\\src\\Positioner\\'.$type;
