...
use Itoris\SmartFormerGold\plugins\dompdf\src\Renderer\AbstractRenderer;
use Itoris\SmartFormerGold\plugins\dompdf\src\Renderer\Block;
use Itoris\SmartFormerGold\plugins\dompdf\src\Renderer\Image;
use Itoris\SmartFormerGold\plugins\dompdf\src\Renderer\ListBullet;
use Itoris\SmartFormerGold\plugins\dompdf\src\Renderer\TableCell;
use Itoris\SmartFormerGold\plugins\dompdf\src\Renderer\TableRowGroup;
use Itoris\SmartFormerGold\plugins\dompdf\src\Renderer\Text;
...
class Renderer extends AbstractRenderer
{
    ...
    public function render(Frame $frame)
    {
        ...
        if ($_dompdf_debug) {
            //echo $frame;
            \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo($frame);
            flush();
        }
