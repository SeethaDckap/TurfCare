 ...
 */
namespace Itoris\SmartFormerGold\plugins\dompdf\src\Image;

use Itoris\SmartFormerGold\plugins\dompdf\src\Dompdf;
use Itoris\SmartFormerGold\plugins\dompdf\src\Helpers;
use Itoris\SmartFormerGold\plugins\dompdf\src\Exception\ImageException;
    ...
    static function clear()
    {
        ...
        foreach (self::$_cache as $file) {
            if (self::$_dompdf->getOptions()->getDebugPng()) {
                \Magento\Framework\App\ObjectManager::getInstance()->get('Itoris\SmartFormerGold\Helper\Data')->_echo("[clear unlink $file]");
            }
            unlink($file);
        }
