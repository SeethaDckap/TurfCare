<?php
namespace LeanSwift\Turfcare\Model\Autocomplete;
...
class SearchDataProvider extends \WeltPixel\SearchAutoComplete\Model\Autocomplete\SearchDataProvider
{
    ...
    )
    {
         ...
         parent::__construct($queryFactory,$itemFactory,$scopeConfig,$search,$searchCriteriaFactory,$searchFilterGroupBuilder,$filterBuilder,$productRepository,$searchCriteriaBuilder,$storeManager,$priceCurrency,$imageHelper,$sortOrderBuilder,$helper,$productVisibility,$categoryFactory,$categoryRepository);
